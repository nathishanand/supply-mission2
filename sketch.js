...
function setup() {
	...
	packageSprite=createSprite(width/2, 80, 10,25);
	...
	packageBody = Bodies.circle(width/2 , 200 , 5 , {restitution:0.1, isStatic:true, density:0.2});
